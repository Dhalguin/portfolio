...
export default function Home() {
  return (
    <main className="min-h-screen py-2">
      ...
      <section className="bg-[url('/banner.png')] bg-cover bg-left bg-[auto 100%] px-4">
        <div className="py-6 flex justify-between">
          <div className="flex flex-col gap-10">
            <div>
              <h2 className="text-6xl">Un gusto conocerte!</h2>
              <h2 className="text-6xl">Soy Dhalgüin Hernández.</h2>
            </div>
            <div className="w-1/2">
      ...
      <Skills />
      <div className="bg-zinc-900 h-1 w-full" />
      <section id="contact_me" className="py-6 flex justify-between gap-10 mb-8">
